...
class CostasAdvanced extends StatefulWidget{
  const CostasAdvanced ({Key key}) : super(key: key);

  @override
  _TTodoListWidget createState() => _TTodoListWidget();
}

class _TTodoListWidget extends State<CostasAdvanced> {
  @override
  Widget build(BuildContext context) {
    var provider = Provider.of<TodosProvider>(context);
    var todos = provider.CostasAvancado;
