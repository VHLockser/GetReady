...
class OmbrosAdvanced extends StatefulWidget{
  const OmbrosAdvanced ({Key key}) : super(key: key);

  @override
  _TTodoListWidget createState() => _TTodoListWidget();
}

class _TTodoListWidget extends State<OmbrosAdvanced> {
  @override
  Widget build(BuildContext context) {
    var provider = Provider.of<TodosProvider>(context);
    var todos = provider.OmbrosAvancado;
