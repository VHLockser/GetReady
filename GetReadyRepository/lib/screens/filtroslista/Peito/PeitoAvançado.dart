...
class PeitoAdvanced extends StatefulWidget{
  const PeitoAdvanced ({Key key}) : super(key: key);

  @override
  _TTodoListWidget createState() => _TTodoListWidget();
}

class _TTodoListWidget extends State<PeitoAdvanced> {
  @override
  Widget build(BuildContext context) {
    var provider = Provider.of<TodosProvider>(context);
    var todos = provider.PeitoAvancado;
