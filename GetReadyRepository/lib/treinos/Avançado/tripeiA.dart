...
class TripeiAvancado extends StatefulWidget {

  const TripeiAvancado({
    Key key,
  }) : super(key: key);
...
class _Workout_Screen extends State<TripeiAvancado>with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context){
    ...
    final todos = provider.TricepsPeitoAvancado;
    return Scaffold(
      body: Container(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('assets/exercicios/tTeP3.png'),
                      fit: BoxFit.cover,
