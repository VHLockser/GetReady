...
class PerombMedio extends StatefulWidget {
...
class _Workout_Screen extends State<PerombMedio>with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context){
    ...
    final todos = provider.PernasOmbrosMedio;
    return Scaffold(
      body: Container(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('assets/exercicios/tPeO2.png'),
                      fit: BoxFit.cover,
