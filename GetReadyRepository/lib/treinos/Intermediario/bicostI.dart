...
class BicepsCostasMedio extends StatefulWidget {

  const BicepsCostasMedio ({
    Key key,
  }) : super(key: key);
...
class _Workout_Screen extends State<BicepsCostasMedio>with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context){
    ...
    final todos = provider.BicepsCostasMedio;
    return Scaffold(
      body: Container(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('assets/exercicios/cb.png'),
                      fit: BoxFit.cover,
